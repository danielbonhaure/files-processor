...
${CRON_TIME_STR} /usr/local/bin/python ${FPROC_HOME}/main.py >> /proc/1/fd/1 2>> /proc/1/fd/1 #JOB_ID_1 \n\
...
sed -i -E \"/JOB_ID_1/ s|\${CRON_REGEX}|\${CRON_TIME_STR}|g\" ${FPROC_HOME}/crontab.conf \n\
